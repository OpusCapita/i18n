...
describe('NumberConverter', () => {
  it('should convert number to value and value to number', () => {
    ...
    assert.strictEqual(dc.valueToString('10000000'), '10,000,000.00');
    assert.strictEqual(dc.valueToString('10,000,000.00'), '10,000,000.00');
    assert.strictEqual(dc.valueToString(-10000), '-10,000.00');
    assert.strictEqual(dc.valueToString('-10000'), '-10,000.00');
    assert.strictEqual(dc.valueToString('-10,000.00'), '-10,000.00');
    assert.strictEqual(dc.valueToString(1100.99), '1,100.99');
    assert.strictEqual(dc.valueToString('1100.99'), '1,100.99');
    assert.strictEqual(dc.valueToString('1,100.99'), '1,100.99');
    ...
    assert.strictEqual(dc.valueToString(1.005), '1.01');
    assert.strictEqual(dc.valueToString('1.005'), '1.01');
    assert.strictEqual(dc.valueToString(1111.245), '1,111.25');
    assert.strictEqual(dc.valueToString('1111.245'), '1,111.25');
    assert.strictEqual(dc.valueToString('1,111.245'), '1,111.25');
    assert.strictEqual(dc.valueToString('9007199254740989.07'), '9,007,199,254,740,989.07');
    assert.strictEqual(dc.valueToString('9,007,199,254,740,989.07'), '9,007,199,254,740,989.07');

    dc = new NumberConverter('#,##0.00', null, '.');

    assert.strictEqual(dc.valueToString(10000), '10000.00');
    assert.strictEqual(dc.valueToString('10000'), '10000.00');
    assert.strictEqual(dc.valueToString('10000.00'), '10000.00');
    assert.strictEqual(dc.valueToString(-10000), '-10000.00');
    assert.strictEqual(dc.valueToString('-10000'), '-10000.00');
    assert.strictEqual(dc.valueToString('-10000.00'), '-10000.00');
    ...
    assert.strictEqual(dc.valueToString('1100,55'), '1 100,55');
    assert.strictEqual(dc.valueToString('1 100,55'), '1 100,55');
    assert.strictEqual(dc.valueToString(-1.1), '-1,10');
    assert.strictEqual(dc.valueToString('-1,1'), '-1,10');
    assert.strictEqual(dc.valueToString('-1,10'), '-1,10');
    assert.strictEqual(dc.valueToString(-1.9), '-1,90');
    assert.strictEqual(dc.valueToString('-1,9'), '-1,90');
    assert.strictEqual(dc.valueToString('-1,90'), '-1,90');
    ...
    assert.strictEqual(dc.valueToString('10000.99'), '10`001');
    assert.strictEqual(dc.valueToString('10`001'), '10`001');
